...
struct PgCatalogClassBuilder {
    ...
    relnamespace: Int32Builder,
    reltype: Int32Builder,
    reloftype: Int32Builder,
    relowner: Int32Builder,
    relam: Int32Builder,
    relfilenode: Int32Builder,
    reltablespace: Int32Builder,
    relpages: Int32Builder,
    reltuples: Float32Builder,
    relallvisible: Int32Builder,
    reltoastrelid: Int32Builder,
...
impl PgCatalogClassBuilder {
    fn new() -> Self {
        ...
        Self {
            ...
            relnamespace: Int32Builder::new(capacity),
            reltype: Int32Builder::new(capacity),
            reloftype: Int32Builder::new(capacity),
            relowner: Int32Builder::new(capacity),
            relam: Int32Builder::new(capacity),
            relfilenode: Int32Builder::new(capacity),
            reltablespace: Int32Builder::new(capacity),
            relpages: Int32Builder::new(capacity),
            reltuples: Float32Builder::new(capacity),
            relallvisible: Int32Builder::new(capacity),
            reltoastrelid: Int32Builder::new(capacity),
            ...
            relrewrite: Int32Builder::new(capacity),
...
impl TableProvider for PgCatalogClassProvider {
    ...
    fn schema(&self) -> SchemaRef {
        Arc::new(Schema::new(vec![
            ...
            Field::new("reltype", DataType::Int32, false),
            Field::new("reloftype", DataType::Int32, false),
            ...
            Field::new("relfilenode", DataType::Int32, false),
            ...
            Field::new("reltoastrelid", DataType::Int32, false),
            ...
            Field::new("relrewrite", DataType::Int32, false),
