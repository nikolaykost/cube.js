...
struct PgCatalogProcBuilder {
    ...
    pronamespace: Int32Builder,
    proowner: Int32Builder,
    prolang: Int32Builder,
    procost: Float32Builder,
    prorows: Float32Builder,
    provariadic: Int32Builder,
    // TODO: type regproc?
    ...
    prorettype: Int32Builder,
    // TODO: List<Int32>!
    proargtypes: StringBuilder,
    proallargtypes: ListBuilder<Int32Builder>,
    ...
    protrftypes: ListBuilder<Int32Builder>,
...
impl PgCatalogProcBuilder {
    fn new() -> Self {
        ...
        Self {
            ...
            pronamespace: Int32Builder::new(capacity),
            proowner: Int32Builder::new(capacity),
            prolang: Int32Builder::new(capacity),
            procost: Float32Builder::new(capacity),
            prorows: Float32Builder::new(capacity),
            provariadic: Int32Builder::new(capacity),
            ...
            prorettype: Int32Builder::new(capacity),
            proargtypes: StringBuilder::new(capacity),
            proallargtypes: ListBuilder::new(Int32Builder::new(capacity)),
            ...
            protrftypes: ListBuilder::new(Int32Builder::new(capacity)),
...
impl TableProvider for PgCatalogProcProvider {
    ...
    fn schema(&self) -> SchemaRef {
        Arc::new(Schema::new(vec![
            ...
            Field::new("proowner", DataType::Int32, false),
            Field::new("prolang", DataType::Int32, false),
            Field::new("procost", DataType::Float32, false),
            Field::new("prorows", DataType::Float32, false),
            Field::new("provariadic", DataType::Int32, false),
