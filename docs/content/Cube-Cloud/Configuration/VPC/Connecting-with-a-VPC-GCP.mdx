---
title: Connecting with a VPC on Google Cloud
permalink: /cloud/configuration/connecting-with-a-vpc/gcp
---
...
request][gcp-docs-vpc-peering] through the [GCP Web Console][gcp-console] or
through an IaC tool. To send a VPC peering request through the Google Cloud
Console, follow [the instructions here][gcp-docs-create-vpc-peering], with the
